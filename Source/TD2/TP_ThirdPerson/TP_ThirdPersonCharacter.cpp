...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Restart", IE_Pressed, this, &ATP_ThirdPersonCharacter::CallRestartPlayer);
}
...
void ATP_ThirdPersonCharacter::Destroyed()
{
	Super::Destroyed();
...
void ATP_ThirdPersonCharacter::CallRestartPlayer()
{
...
void ATP_ThirdPersonCharacter::ActivateBoostJump(float boostValue, float timer)
{
	boostJumpValue = boostValue;
	GetWorld()->GetTimerManager().ClearTimer(jumpBoostTimerHandle);

	GetCharacterMovement()->JumpZVelocity *= boostValue;

	GetWorld()->GetTimerManager().SetTimer(jumpBoostTimerHandle, this, &ATP_ThirdPersonCharacter::DeactivateBoostJump, timer, false);
}

void ATP_ThirdPersonCharacter::DeactivateBoostJump()
{
	GetCharacterMovement()->JumpZVelocity /= boostJumpValue;
}